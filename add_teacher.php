...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM src_ec WHERE email='{$email}'";
        $result = mysqli_query($conn, $sql);

        if (mysqli_num_rows($result) === 1) {
            $row = mysqli_fetch_assoc($result);
    $_SESSION['ec_home']=$username;
...
<body style="background: url('HOS.jpg'); background-size: cover;">
        ...
        <div class="header-container">
            ...
            <div class="site-nav-menu">
                <ul class="primary-menu">
                    <li>
                    <li><a class="active" aria-current="page"  href="add_teacher.php">Register</a></li>
                    <a id="log" href="teacher_login.php">Login</a> </li>
                </ul>
            </div>
        </div>
    </header>
    ...
    <section class="w3l-mockup-form">
                ...
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <form action="add_user.php" method="POST">
                            ...
                            <input type="email" name="student_ID" placeholder="Email" required>
                            
                            
                            <input type="number" name="gender" placeholder="Contact" required>
                            
                            <input type="text" name="class" placeholder="Staff ID" required>

                            <input type="password" name="address" placeholder="Password" required>
                            
                            <input type="text" name="hometown" placeholder="Reset Code" required>

                         <!--   <input type="file" id="profile" name="image"> -->
                            
                           <button style="background: black;" class="btn" name="submit" type="submit">Register</button>
                           <br><br>

                          <a href="teacher_login.php">Already Registered</a>
                        </form>
                        
                    </div>

                    <div style="background: url('sch.jpg');" class="w3l_form align-self">
        ...
        <div class="text-center text-light" style="color: white">
                   Copyright &copy; 2022 Time Schedule System. All rights reserved.
        </div>
    </section>
    <!-- //form section start -->       
