				...
				<div class="col-md-10">
					<div class="card mb-3">
						...
						<div class="row g-0">
						    ...
						    <div class="col-md-8">
						      	<div class="card-body">
						        	<h5 class="card-title">LODGE COMPLAIN</h5>
									...
									<form action="user.complains.php" method="POST" enctype="multipart">
									
									<input type="text" name="full_name" id="notifications_name" class="form-control" value="<?php echo $data['full_name'] ?>" hidden>

        							<input type="text" name="email" id="notifications_name" class="form-control" value="<?php echo $data['email'] ?>" hidden>

        							<textarea style="resize:none; width: 80%; height: 10rem;" name="user_msg" > </textarea> <br>       							<button id="loginbtn" type="submit" style="padding: 10px; font-size: 15px;background-color: darkred; color: white; border-radius: 5px; border: 0px;">SEND</button>
        						</form>
