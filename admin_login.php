        ...
        <div class="header-container">
            ...
            <div class="site-nav-menu">
                <ul class="primary-menu">
                    <li>
                    <a class="active" aria-current="page" href="admin_login.php">Admin</a> </li>
        ...
        <div class="container">
            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
                    <div style="background-image: url('log.jpg');" class="w3l_form align-self">
                    ...
                    <div class="content-wthree">
                        ...
                        <?php 
                         ...
                         ?>
                        <form action="admin_logins.php" method="POST">
                           ...
                           <br><br>
                          <!--   <a href="admin.registration.php" style="padding-left: 80px;">New Admin</a><br>
                           <a href="forgot-password.php" style="padding-left: 80px;">Fogot Password?</a> -->
