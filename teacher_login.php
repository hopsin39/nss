        ...
        <div class="header-container">
            ...
            <div class="site-nav-menu">
                <ul class="primary-menu">
                    <li>
                    <li><a class="active" aria-current="page"  href="teacher_login.php">Staff</a></li>
            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <form action="teacher_logins.php" method="POST">
                            <input type="number" name="staff_ID" placeholder="Staff ID" required>
                            <input type="password" name="password" placeholder="Password" required>
                            
                           <button style="background: black;" name="submit" name="submit" class="btn" type="submit">Login</button>
                           <br><br>
                           <a href="user_register.php"><input class="btn btn-primary" value="REGISTER" style="background-color: GREEN;"></a>
