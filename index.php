...
<body style="background: url('sch.jpg'); background-size: cover;">
    ...
    <section class="w3l-mockup-form">
        ...
        <div class="container">
            ...
            <div class="main-mockup" style="display: block;">
            <div class="w3l_form align-self">
          <div class="left_grid_info">
          <img src="log.jpg" style="height: 180px; width: 180px; margin-bottom: 30px; border-radius: 50%">
           </div>
        </div>

        <h4 style="text-align: center; font-size: 30px; padding-top: 5px; padding-bottom: 5px; color: white; text-transform: uppercase;">Welcome to<br><br><span style="font-size: 70px;"> TIME SCHEDULE SYSTEM</span></h4>

        <a href="teacher_login.php" style="font-size: 20px; color: white; padding-left: 30%">>>>>> Click to login <<<<<<<<< </a>
