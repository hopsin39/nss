...
<body class="d-flex flex-column h-100">
    ...
    <main class="flex-shrink-0">
        <br><br><br><br><br>
        <div class="container">
            <h1 class="mt-5">Hello! Doctor</h1>
            <h2 style="background: black; opacity: 70%; color: white; padding: 10px; text-align: center; font-size: 20px;">Please Enter Your Credentials</h2>
            <div class="form">
                <form method="POST" action="userLogin.php">
                    ...
                    <a href="user_register.php" style="color: blue;">Register</a>
                </form>
            </div>
</br>
</br></br></br></br>
