        ...
        <div class="header-container">
           ...
           <div class="site-nav-menu">
                <ul class="primary-menu">
                    ...
                    <li><a class="active" aria-current="page" href="accounts_list.php">Complain</a></li>
...
<div class = "row">
    <div class = "col-xl-12">
        <h1 class = "text-center pt-5"> COMPLAINS </h1>
...
?>
    ...
    <td style="text-transform:uppercase;"><?php echo $row['email']; ?></td>
     <td style="text-transform:uppercase;"><?php echo $row['complain_msg']; ?></td>
    <td style="text-transform:uppercase;"><?php echo $row['complain_date']; ?></td>
    <td style="text-transform:uppercase;"><?php echo $row['admin_response']; ?></td>
   
    <td>
    <div style="display:flex;">

   
            <form action="reply_update.php" method="POST" enctype="multipart">
            <input type="text" name="staff_ID" value="<?php echo $row['complain_id']; ?>" hidden>
            <button style="background: darkred; color: white; padding: 8px; border: none; margin: 5px;">Reply</button>
            </form>
