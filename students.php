        ...
        <div class="header-container">
           ...
           <div class="site-nav-menu">
                <ul class="primary-menu">
                    ...
                    <li><a class="active" aria-current="page" href="students.php">Schedules</a></li>
...
<div class = "row">
    <div class = "col-xl-12">
        <h1 class = "text-center pt-5"> STAFF SCHEDULES </h1>

        <form action=" " method="POST" enctype="multipart">
            <button type="button" onclick="window.location.reload();" style="background: darkblue; color: white; padding: 8px; border: none; margin: 5px;">Update Schedule</button>
        </form>
...
?>
    ...
    <td style="text-transform:uppercase;"><?php echo $row['contact']; ?></td>
     <td style="text-transform:uppercase;"><?php echo $s; ?>:0<?php echo $s; ?>:<?php echo $y; ?>0</td>
    <td style="text-transform:uppercase;"><?php echo $row['end_time']; ?></td>
        </tr>
